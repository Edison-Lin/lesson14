            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <?php 
                        ...
                        //     echo "<script language='javascript'>alert('謝謝您，會員資料已完成註冊');location.herg='index.php';</script>";
                        // }
                    if(true){
                        if (isset($_POST['formct1']) && $_POST['formct1'] == 'reg') {
                            $email = $_POST['email'];
...
?>
                    <div class="row">
                        <div class="col-8 offset-2 text-left">
                            <form id="reg" name="reg" action="register-success.php" method="POST">
    ...
    <script type="text/javascript">
        ...
        //Upload Failed:上船發生錯誤處理
        function errorHandler(event) {
            alert("Upload Failed:上傳發生錯誤");
        }
        //Upload Aborted:上船作業取消處理
        ...
        $(function() {
            ...
            //取的鄉鎮市代碼，查詢郵遞區號放入#myZip,#zipcode
